    ...
    window.FlutterwaveCheckout({
      ...
      callback: async function (response: any) {
        ...
        if (response.status === 'successful') {
          // Save to Firebase + send emails automatically
        ...
        {!success ? (
          ...
          <div style={{ textAlign: 'center', padding: '32px 0' }}>
            ...
            <p style={{
              ...
              Your receipt has been sent to your email. Our clinical team has been notified and will be in touch within 24 hours to begin your care setup.
            </p>
            <button
              className="btn btn-forest"
              onClick={onClose}
